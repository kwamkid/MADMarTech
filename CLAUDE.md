...
หน้าที่มีตารางกว้างใส่ `<body … data-wide>` = เฉพาะส่วนเนื้อหา (.wrap.layout) กว้าง 1440px · hero/header/footer คง 1140px (ใช้ที่ compare) · hero ที่มีคลิป 9:16 ใช้ `.hero.split.v916` (คลิป 180px)
