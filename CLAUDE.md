...
compare.html          Model Compare — **decision matrix 8 โมเดล · วัดเฉพาะงานสร้างคลิปคนพูดภาษาไทย (อาจารย์ย้ำ) ไม่ใช่คุณภาพวิดีโอทั่วไป** (6 เกณฑ์ 1–5 × น้ำหนัก = /100 · ปุ่มสมดุล/คุ้ม/ภาพสวย/เสียงไทย (ไม่มี slider — อาจารย์ว่าดูแล้วงง) · `[data-matrix]` ใน site.js · คะแนนอาจารย์แก้แล้ว 25 ก.ย.: Omni 1.1 91 · Omni 88 · Veo 83 · MiniMax 79 · Grok 67 · Seedance 58 · Kling pro 57 · FLUX 44 — แก้คะแนนต้องแก้ 4 ที่: data-s ในตาราง · การ์ด/ItemList · llms.txt · ทำ teaser ใหม่ทั้ง 2 ไฟล์ (ซับมีคะแนน+ลำดับ) แล้วเปลี่ยน ?v=) + การ์ดคลิป 8 ตัวเรียงตามคะแนน (ไม่มี badge PASS/FAIL แล้ว — ใช้คะแนนแทน · หัวข้อแก้คลิปเดิมยังมี badge) + หัวข้อ "แก้คลิปเดิม" (Genjutsu MC/RO · Extend · Viral preset — ไม่นับคะแนน · เอา Kling Omni Edit ออก 25 ก.ย. เพราะคลิปเทสต์ไม่ได้เปลี่ยนเป็นคนใหม่จริง) · FAQ + ItemList schema
...
- Teaser หน้า Compare: hero ใช้ `teaser-8-models-16x9.mp4` (1280×720 · คลิปซ้าย ข้อมูลขวา: ชื่อ · SCORE · CREDITS · MAX · จุดลำดับ) · เวอร์ชัน 9:16 `teaser-8-models.mp4` เก็บไว้ลง Reels/TikTok (8 โมเดล × 3 วิ · ซับ MODEL/CREDITS/SCORE ทำเป็น PNG ด้วย PIL แล้ว overlay เพราะ ffmpeg ของ Homebrew ไม่มี drawtext) · คลิปเต็ม 8 ตัว 540p อยู่ `assets/videos/compare/NN-slug.mp4/.jpg` · ถ้าคะแนนเปลี่ยน ต้องทำ teaser ใหม่ (สคริปต์เดิมอยู่ใน scratchpad ของ session 25 ก.ย. — เขียนใหม่ได้จากคำอธิบายนี้)
